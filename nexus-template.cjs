...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Invisible Failure Data: Cancer Prediction Computational Strain Tracker";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Cancer Prediction Failure Event";
process.env.TABLE_NAME = process.env.TABLE_NAME || "cancer_prediction_failure_event_records";
'use strict';
